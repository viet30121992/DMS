CREATE STRUCTURED PRIVILEGE EXT.ALL_SECURITY_EXT_ITC FOR SELECT
	ON  EXT.CSA_INC01_BVL,
		...
		EXT.CSA_BVL_ITC_INC11,
		EXT.CSA_BVL_ITC_INC14,
		EXT.CSA_BVL_ITC_INC34,
		EXT.CSA_BVL_ITC_INC43,
		EXT.CSA_BVL_ITC_INC50,
		EXT.CSA_BVL_ITC_INC51
WHERE EXISTS ( SELECT
				 NULL 
				FROM 
					CSA_DATASECURITY 
...
GRANT STRUCTURED PRIVILEGE EXT.PG_SECURITY_EXT_BRANCH_CODE_ITC  TO 0323;
